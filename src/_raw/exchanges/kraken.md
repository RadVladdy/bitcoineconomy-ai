...
**Coverage.** Broad international coverage with a range of fiat currencies. *(Verify current availability + restricted regions before publish.)*
...
**Links.** [kraken.com](https://kraken.com) · API docs *(verify URL).*
