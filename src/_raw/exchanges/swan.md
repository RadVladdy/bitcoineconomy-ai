...
**Agent access.** Primarily a **scheduled-buy** model rather than a general programmatic trading API — best fit for an agent that wants a hands-off, rules-based path to build a Bitcoin *reserve* over time.
