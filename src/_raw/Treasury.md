...
This is the old Marketplace overview, renamed to what it actually is. The page was always treasury + gateway-compliance + boundary-risk — the operational core of the dissolved Border Zone — never a "marketplace." The 2026-06-13 IA fix split the old `/marketplace` page: the live services directory takes the **Marketplace** name (the section is now **The Market**), and this operational/boundary content moves here under an honest title. The body is unchanged from the approved Marketplace overview; only its home and title changed.

The line with Exchange still holds: this page answers "what does an agent hold and what must it accept at the boundary"; [[Exchange]] answers "how does it actually convert, tool by tool." Don't duplicate.
