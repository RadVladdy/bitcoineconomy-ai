...
The easy misreading of this contest is that it is a fight between Lightning and everything else. It is not. Several of the strongest entries in the incumbent stack are perfectly willing to use Bitcoin's rails where they are faster or cheaper. What they will not give up is the **asset** and the **trust model** layered on top. That the rails themselves trend off-chain — Lightning and Lightning-shaped layers, because a faster monolithic chain doesn't scale — is the Phase-1 argument settled at [[Why-Lightning-Not-A-Fast-Chain|Why Lightning, Not a "Fast" Chain]]; the live skirmish here is over what rides on those rails, not the rails themselves.
...
> - **[[Why-Lightning-Not-A-Fast-Chain|Why Lightning, Not a "Fast" Chain]]** *(Phase 1 — the theory)* — why the rails trend off-chain to Lightning and not a faster chain; the scaling argument these live skirmishes are the field test of.
> - **[[Why-Bitcoin-Not-A-New-Coin|Why Bitcoin, Not a New Coin]]** *(Phase 2 — the asset)* — the settlement-asset axis the live fight has already moved to: why the contested asset resolves toward Bitcoin, not a new coin.
