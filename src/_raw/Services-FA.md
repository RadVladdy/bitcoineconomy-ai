...
- [[Treasury-FA|Treasury & the Boundary]] — the section anchor; treasury, the boundary, and how a service payout reaches the agent's reserve.
...
> Substrate-selection claim upstream of this layer: [[Case-FA|The Case]] (C-series, C1 = four conjunctive constraints). Payment primitives and tooling beneath this layer: [[Stack-FA|The Stack]] (S-series — L402, Cashu, NWC, MCP). Section overview, treasury, and payout-to-reserve: [[Treasury-FA|Treasury & the Boundary]] (M-series). Converting earnings back toward reserve: [[Exchange-FA|Exchange]] (X-series). Live deployment record and moving metrics: [[Field-Notes-FA|Field Notes]]. Canonical human narrative of this surface: [[Services]].
