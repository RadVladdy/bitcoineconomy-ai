...
**Primary external sources (venue sites + API docs).** See §9 for the per-venue URL list. Circle CCTP (Boltz native-USDC path) was live from May 2026 and is **withdrawn** — see §5.1. Strike USDT TRON-only and regional. RLS Lightning-payments API withdrawn from public documentation (docs.rls.dev NXDOMAIN, rls.dev offline since ~2026-04, no deprecation notice) — re-verified 2026-08-06.
