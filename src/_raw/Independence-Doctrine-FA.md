...
**Regulated stablecoin issuers (Circle, Tether, successors).** *(structural)* Property in the bundle that precludes adaptation: freeze function as regulatory-license requirement. Constraint precluded: Case-FA 2 (censorship-resistance). Soft-adaptation path: issuers tighten freeze policy or improve transparency, but the freeze capability itself cannot be removed without losing the regulatory license. Predicted outcome: stablecoins remain viable for use cases that accept issuer counterparty risk; they cannot serve as the parallel-economy substrate. Competing-substrate combat at [[Border-Skirmishes-FA|Border Skirmishes]]; gateway/interface treatment at [[Treasury-FA|Treasury]].
...
- **Bridge architecture (forming).** Custodians (Coinbase, Kraken, River, Strike); regulated on-ramps and off-ramps; treasury-management services; eventually purpose-built regulated agent-payment gateways. Full operational treatment at [[Treasury-FA|Treasury]].
