...
The substrate question has two halves, and this page is the second. Its companion [[Why-Lightning-Not-A-Fast-Chain|Why Lightning, Not a "Fast" Chain]] argues the *rails* — why agent payments scale off-chain on Lightning rather than on a faster chain — an asset-agnostic argument that lands first, in Phase 1. This page argues the *asset*: once volume forces payments onto those rails, *which money settles on them* is the question that remains (Phase 2), and the property bundle below is why the answer is Bitcoin. Rails before substrate — two engines pulling the same direction, not a hedge on whether the substrate is Bitcoin.
...
> - **[[Why-Lightning-Not-A-Fast-Chain|Why Lightning, Not a "Fast" Chain]]** *(the Phase-1 pair)* — the rails half of the substrate question: this page argues the *settlement asset* (Phase 2); that one argues the *rails* (Phase 1). Together they are the two halves of the substrate question.
...
> - **[[Marketplace|The Agent Marketplace]]** *(The Market)* — where the single base money does its work: what an agent holds ([[Treasury]]), how it crosses ([[Exchange]]), and the services priced in it ([[Services]]).
...
- [[Why-Lightning-Not-A-Fast-Chain]] (this project) — the Phase-1 rails pair (the scaling half of the substrate question)
