...
export const GET: APIRoute = async () => {
  ...
  L.push('## The Agent Marketplace — live directory (separate site)');
  L.push('The live, self-refreshing directory of agent-payable services at https://marketplace.bitcoineconomy.ai: a curated registry behind an agent-drivable-API inclusion bar, live Nostr provider/mint announcements, six-hourly endpoint liveness probes, and a cross-provider sats-per-token price index. Consumption: manifest https://marketplace.bitcoineconomy.ai/llms.txt (one-fetch start) · START HERE the mastered directory https://marketplace.bitcoineconomy.ai/live/master.json · registry (curated tier only) https://marketplace.bitcoineconomy.ai/directory.json · tool catalogue https://marketplace.bitcoineconomy.ai/tools.json · the buy side (signed kind-38556 work requests) https://marketplace.bitcoineconomy.ai/live/bounties.json · the sell side (kind-38555 announcements) https://marketplace.bitcoineconomy.ai/live/announced.json · live snapshot https://marketplace.bitcoineconomy.ai/live/snapshot.json · price index https://marketplace.bitcoineconomy.ai/live/models.json · uptime history https://marketplace.bitcoineconomy.ai/live/uptime.json · MCP server POST https://marketplace.bitcoineconomy.ai/mcp.');
  L.push('');
