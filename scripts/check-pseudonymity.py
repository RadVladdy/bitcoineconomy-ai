...
SITE = 'bitcoineconomy.ai'
BUILT = ['dist', 'marketplace-site']        # what the public can actually fetch
SOURCE = ['src', 'scripts', 'marketplace-site']      # what gets scanned for the two mechanisms
...
ALLOWED = [
           r'Bitcoineconomyai@gmail\.com',  # the brand contact address, published on purpose,
           r'hello@getalby\.com',  # a vendor's public contact, quoted in a service card,
